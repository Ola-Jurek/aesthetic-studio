            ...
            <Container>
                ...
                <Row className='treatment_section2'>
                    <Col sm={12}>
                        ...
                        <ul>
                            <li> Osoby z oznakami starzenia – zabieg redukuje drobne zmarszczki i poprawia napięcie
                                skóry. </li>
                            <li> Osoby z bliznami potrądzikowymi – mikronakłuwanie wspiera wygładzenie i rozjaśnienie
                                blizn.
                            </li>
                            <li> Osoby z rozszerzonymi porami – zabieg zmniejsza widoczność porów i poprawia strukturę
                                skóry.
                            </li>
                            <li> Osoby z przebarwieniami – pomaga wyrównać koloryt skóry.</li>
                            <li> Osoby z utratą jędrności skóry – zabieg poprawia elastyczność i ogólną kondycję
                                skóry.
                            </li>
                        </ul>
                        ...
                        <ul>
                            <li> Zaleca się serię 3-6 zabiegów, wykonywanych co 4 tygodnie, aby uzyskać najlepsze
                                rezultaty.
                            </li>
                            <li> Pierwsze efekty można zauważyć już po pierwszym zabiegu, jednak pełna regeneracja skóry
                                następuje po zakończeniu serii.
                            </li>
                        ...
                        <ul>
                            <li> Unikaj ekspozycji na słońce przez 2 tygodnie po zabiegu, stosując krem z filtrem SPF
                                50+.
                            </li>
                            <li> Zadbaj o nawilżenie skóry – używaj kremów regenerujących i nawilżających przez kilka
                                dni po zabiegu.
                            </li>
                            <li> Nie stosuj makijażu przez 24-48 godzin, aby umożliwić skórze pełną regenerację.</li>
                            <li> Unikaj intensywnego wysiłku fizycznego, sauny i basenu przez 48 godzin, aby zmniejszyć
                                ryzyko podrażnień.
                            </li>
                        ...
                        <p> Zapraszamy na konsultację, gdzie nasi specjaliści dobiorą odpowiedni plan zabiegowy
                            dostosowany
                            do Twoich potrzeb. Pozwól sobie na młodszy i zdrowszy wygląd skóry – już dziś umów się na
                            wizytę!
                        </p>
